...
class TemplateController extends AbstractActionController
{
    public function indexAction()
    {
        ...
        $view->setVariables(['records' => $records]);
    ...
    public function editAction()
    {
        ...
        if ($this->getRequest()->isPost()) {
            ...
            if ($form->isValid()) {
                ...
                if (!empty($pictureInfo) && $pictureInfo['name'] != '') {
                    ...
                    unlink('public/pictures/' . $record['template_picture']);
                ...
                $this->redirect()->toRoute('admin/template');
            }
        }
        ...
        $view->setVariables(['form' => $form, 'record' => $record]);
        $view->setTemplate('admin/template/form.phtml');
