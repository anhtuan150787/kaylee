...
class OrderController extends AbstractActionController
{
    ...
    public function indexAction()
    {
        ...
        $view->setVariables(['records' => $records, 'status' => $this->status, 'search' => $search]);
    ...
    public function editAction()
    {
        ...
        $view->setVariables(['form' => $form, 'record' => $record, 'order' => $order]);
        $view->setTemplate('admin/order/form.phtml');
