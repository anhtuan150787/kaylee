    ...
    public function editAction()
    {
        ...
        if ($this->getRequest()->isPost()) {
            ...
            if ($form->isValid()) {
                ...
                $this->redirect()->toRoute('admin/website');
            }
        }
        ...
        $view->setVariables(['form' => $form, 'record' => $record, 'actionTitle' => $actionTitle, 'message' => $message]);
        $view->setTemplate('admin/website/form.phtml');
