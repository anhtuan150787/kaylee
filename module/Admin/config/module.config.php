...
return array(
                ...
                'child_routes' => array(
                    ...
                    'color' => array(
                        ...
                        'options' => array(
                            'route' => '/color[/:action]',
                            'constraints' => [
                                'controller' => 'Admin\Controller\Color',
                                'action' => '[a-zA-Z][a-zA-Z0-9_-]*',
                            ],
                            'defaults' => [
                                '__NAMESPACE__' => 'Admin\Controller',
                    ...
                    'size' => array(
                        ...
                        'options' => array(
                            'route' => '/size[/:action]',
                            'constraints' => [
                                'controller' => 'Admin\Controller\Size',
                                'action' => '[a-zA-Z][a-zA-Z0-9_-]*',
                            ],
                            'defaults' => [
                                '__NAMESPACE__' => 'Admin\Controller',
    ...
    'controllers' => array(
        'invokables' => array(
            ...
            'Admin\Controller\Size' => 'Admin\Controller\SizeController',
    ...
    'view_manager' => array(
        ...
        'template_map' => array(
            ...
            'layout/message' => __DIR__ . '/../view/layout/message.phtml',
